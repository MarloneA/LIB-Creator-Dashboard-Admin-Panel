...
const supabaseKey =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ6aHlrYnBsc2d0ZHJxZGljamxiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDE2MjY0MDEsImV4cCI6MjAxNzIwMjQwMX0.oaCX_2R_tiYT4vpKACldJ3VH3uD8LFwuLg5xJAtUpLk";
      ...
      <AuthContext.Provider value={{ user, setUser }}>
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/profile/:id"
              element={<Profile session={session} supabase={supabase} />}
            />
            <Route
